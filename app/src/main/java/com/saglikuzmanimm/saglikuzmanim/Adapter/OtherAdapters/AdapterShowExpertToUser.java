...
public class AdapterShowExpertToUser extends RecyclerView.Adapter<AdapterShowExpertToUser.ExpertShowListHolder> {
    ...
    public void onBindViewHolder(@NonNull ExpertShowListHolder holder, int position) {
        ...
        if (expert.get_point() != 0) {
            ...
            holder.textView_point.setText("Yeni uzman");
        }
        ...
        btn_alert_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    showAlertInfo();
                    sendAppointment(expert, timestamp);
    ...
    private static void sendAppointment(Expert expert, Timestamp timestamp) {
        ...
        appointmentManager.addData(appointment, new IResult() {
            @Override
            public void onSuccess() {
                alertInfo(true);
                sendNotification(expert.get_expertUid(),expert.get_token());
            }
    ...
    private static void sendNotification(String receiverID,String token) {
        String senderID = FirebaseAuth.getInstance().getCurrentUser().getUid();
