package com.saglikuzmanimm.saglikuzmanim.Adapter.JobAdvertisementAdapter;
...
public class AdapterDisplayJobAdvertisementToExpert extends RecyclerView.Adapter<AdapterDisplayJobAdvertisementToExpert.AddListHolderForExpert> {
    ...
    public AddListHolderForExpert onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.fragment_job_advertisement_item_for_expert, parent, false);


        showDialog = new Dialog(context);
        showDialog.setContentView(R.layout.fragment_show_job_advertisement_detail);
    ...
    public void show_detail(int position, View view) {
        ...
        Button btn_send_message = showDialog.findViewById(R.id.btn_sen_message_job_advertisement_dialog);
        btn_send_message.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent = new Intent(context, MessageActivity.class);
                intent.putExtra("receiverName",user.get_firstName() + " " + user.get_lastName());
                intent.putExtra("receiverImage",user.get_profileImage().toString());
                intent.putExtra("receiverID",user.get_ID());
                intent.putExtra("receiverToken",user.get_token());
