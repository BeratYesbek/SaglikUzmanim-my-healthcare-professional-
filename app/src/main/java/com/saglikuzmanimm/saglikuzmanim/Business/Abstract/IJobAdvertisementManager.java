...
public interface IJobAdvertisementManager<T extends IEntity, R extends IResult, E extends IGetListener>
        extends IEntityRepository<JobAdvertisement, IResult, IGetJobAdvertisementListener> {
