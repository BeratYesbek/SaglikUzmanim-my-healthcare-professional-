...
public class FirebaseJobAdvertisementDal implements IFirebaseJobAdvertisementDal<JobAdvertisement, IResult, IGetJobAdvertisementListener> {
    ...
    public void getData(JobAdvertisement entity, IGetJobAdvertisementListener iGetListener) {
        ...
        String uploaderID = firebaseAuth.getCurrentUser().getUid();
            ...
            firebaseFirestore.collection("JobAdvertisements")
                    .whereEqualTo("uploaderID", uploaderID).orderBy("timestamp", Query.Direction.DESCENDING).
    ...
    public void getJobAdvertisementByLocationAndDepartment(String location, String department, IGetJobAdvertisementListener iGetListener) {
        ...
        Query query;
            ...
            if(location != null){
                query = firebaseFirestore.collection("JobAdvertisements").whereEqualTo("job_advertisement_location",location).whereEqualTo("job_advertisement_department",department);

            }else{
                query = firebaseFirestore.collection("JobAdvertisements").whereEqualTo("job_advertisement_department",department);
            }
