...
public interface IFirebaseExpertDal<T extends IEntity, R extends IResult, E extends IGetListener> extends IEntityRepository<Expert, IResult, IGetExpertListener> {
